...
/**
 * This class represents array indexed collection. It is used for storing
 * Objects. It uses array for storing elements.
 */
public class ArrayIndexedCollection extends Collection {
    ...
    public ArrayIndexedCollection(int initialCapacity) {
        if (initialCapacity < 1) {
            throw new IllegalArgumentException("Kapacitet ne može biti manji " +
                    "od 1!");
        }
    ...
    /**
     * Constructor which initializes collection with default capacity and
     * adds all element of given collection to new
     * collection.
     *
    ...
    /**
     * Constructor which initializes collection with given capacity and adds
     * all element of given collection to new
     * collection.
     *
     * @param initialCapacity Initial capacity
     * @param other           Collection which elements will be added
    ...
    /**
     * This method is used for inserting element at given position. Element
     * that was at given position is shifted
     * forward.
     *
