...
/**
 * This class represents empty stack exception. It is thrown when accesing elements from empty stack.
 */
public class EmptyStackException extends RuntimeException{
    ...
    /**
     * Constructor with message, cause and flag for enabling suppression and stack trace.
     *
     * @param message Message that will be shown
     * @param cause Cause of exception
